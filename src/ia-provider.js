...
export async function analisarProgresso(cfg, snapshot) {
  const system =
    ...
    "CONSIDERE o COMPORTAMENTO (campo comportamento): quando houver, sugira aproveitar o melhor dia/faixa do dia (comportamento.melhorDia/melhorFaixa) para as tarefas mais difíceis, e reforce a constância (comportamento.ofensivaDias = sequência de dias seguidos; chame de 'sequência', nunca de 'ofensiva')." +
