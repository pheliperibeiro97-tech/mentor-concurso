...
export const GUIA = [
  ...
  { id: "leijuris", grupo: "Estudo", titulo: "§ Lei Seca · ⚖ Jurisprudência", html: `
      <p>Duas abas em cada tela:</p>
      <ul>
        <li><b>📌 Metas</b> — referências a cumprir (ler). Uma meta vira automaticamente uma <b>tarefa</b> no Planejamento, e o status fica sincronizado nos dois sentidos.</li>
        <li><b>🧠 Memorizar</b> — referências gravadas para relembrar, com <b>revisão espaçada</b> (programar 7/15/30 dias; Esqueci/Lembrei/Fácil ajustam o intervalo na escada 1·7·15·30·60·120).</li>
      </ul>
      <p>Você pode marcar pontos de alta incidência como <b>⭐ PQ (Provável Questão)</b> — manualmente, importando uma estatística, ou por sugestão da IA. Em Jurisprudência há filtros por tribunal (TJSP/STJ/STF/TRT) e tipo (súmula/tema/precedente). Itens com texto podem ser grifados (marcação tricromática) e lidos em <b>📖 Ler em foco</b> (no menu ⋯ do item) — uma coluna limpa e estreita, sem distração.</p>` },

  { id: "questoes", grupo: "Prática", titulo: "✎ Questões · ✔ Questões C/E", html: `
      <p>Banco de questões (múltipla escolha e Certo/Errado, telas gêmeas). <b>Treino</b>: responda, veja o gabarito e o comentário; erro vai para o <b>Caderno de Erros</b>. Filtros por tópico e por situação (pendentes/acertei/errei) e o botão <b>Treinar erros</b> (refaz as erradas em branco). <b>Simulado</b>: igual ao treino, porém cronometrado e com gabarito só no fim. Adicionar questões: digitar/colar, importar de arquivo, ou <b>extrair/gerar com IA</b> 🤖 a partir de um material.</p>` },
  ...
  { id: "flashcards", grupo: "Revisão", titulo: "⟳ Flashcards", html: `
      <p>Revisão espaçada no nível do card (SRS). Ao revisar, avalie <b>Errei / Difícil / Bom / Fácil</b> — os intervalos são fixos por nota (1 / 7 / 15 / 30 dias). Crie manualmente (frente ; verso), importe de arquivo, ou gere automaticamente: <b>do material</b> (🤖) e <b>das questões</b> (offline). Na revisão dá para <b>✨ Comentar com IA</b> (explica o porquê) e mandar ao <b>Caderno de Erros</b>.</p>` },
