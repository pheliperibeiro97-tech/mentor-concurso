...
export const GUIA = [
  ...
  { id: "sync-nuvem", grupo: "IA, dados e privacidade", titulo: "Sincronização entre celular e computadores", html: `
      ...
      <ul>
        ...
        <li><b>Esqueceu a senha?</b> Não há recuperação — ninguém a guarda. Saídas: (a) num aparelho ainda conectado, <b>Configurações → Dados → Ver senha</b> mostra a que está salva ali; (b) sem nenhum conectado, use <b>Backup completo</b> num aparelho e <b>Importar backup</b> no outro, que não pede senha; (c) se os dados já estão no aparelho, escolha uma <b>senha nova</b> — ela cria um cofre novo. Ao conectar, preencha o campo <b>Dica</b>: ela fica no aparelho e aparece ao reconectar.</li>
