  ...
  root.innerHTML = `
    ...
    <details class="ed-ajuda">
      ...
      <div class="ed-ajuda-corpo">
        ...
        <p>${icone("target")} <b>Estudar</b> — em tela cheia: <b>Certo/Errado</b>, <b>Completar a letra</b>, <b>Revisar o que vence</b> e <b>Refazer erros</b>${tipo === "juris" ? ", além da <b>Súmula-duelo</b> (número/tribunal trocado)" : ""}. Escolha o <b>escopo</b> (tudo ou o que mais cai); começa com um toque no padrão e, em <b>Opções…</b>, você ajusta <b>quantidade e dificuldade</b> — dá ainda para gerar <b>flashcards</b> e <b>questões</b>.</p>
